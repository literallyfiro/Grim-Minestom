...
public class BoundingBox {
    ...
    public BoundingBox(MutableVector min, MutableVector max) {
    ...
    public BoundingBox add(MutableVector vector) {
    ...
    public boolean intersectsWithBox(MutableVector vector) {
    ...
    public MutableVector getMinimum() {
        return new MutableVector(minX, minY, minZ);
    }

    public MutableVector getMaximum() {
        return new MutableVector(maxX, maxY, maxZ);
    }

    public boolean collides(MutableVector vector) {
        return (vector.getX() >= this.minX && vector.getX() <= this.maxX) && ((vector.getY() >= this.minY && vector.getY() <= this.maxY) && (vector.getZ() >= this.minZ && vector.getZ() <= this.maxZ));
    }

    public boolean collidesHorizontally(MutableVector vector) {
        return (vector.getX() >= this.minX && vector.getX() <= this.maxX) && ((vector.getY() > this.minY && vector.getY() < this.maxY) && (vector.getZ() >= this.minZ && vector.getZ() <= this.maxZ));
    }

    public boolean collidesVertically(MutableVector vector) {
        return (vector.getX() > this.minX && vector.getX() < this.maxX) && ((vector.getY() >= this.minY && vector.getY() <= this.maxY) && (vector.getZ() > this.minZ && vector.getZ() < this.maxZ));
    }
