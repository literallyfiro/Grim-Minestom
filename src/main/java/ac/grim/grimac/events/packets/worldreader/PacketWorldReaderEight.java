...
//    @Override
//    public void handleMapChunkBulk(final GrimPlayer player, final PlayerPacketOutEvent event) {
...
//
//    @Override
//    public void handleMapChunk(final GrimPlayer player, final PlayerPacketOutEvent event) {
//        PacketWrapper wrapper = new PacketWrapper(event);
//
